...
<body onload="pageloaded()">
    ...
    <div class="sidebar-main-container" id="sidebar">
        ...
        <a id="courses" href="index.php" class="sidebar-item-container noSelect">
    ...
    <div class="body">
        ...
        <form action="addcourse.php" method="post" class="main-card">


            <div class="inputs">
                <label>الأسم</label>
                <input onkeyup="name_change()" id="name" type="text" name="name" value="" required placeholder="أسم المادة " autocomplete="off">


                <label>رمز المادة</label>
                <input onkeyup="name_change()" id="number" type="text" name="number" value="" required placeholder="رمز المادة " autocomplete="off">
            </div>
            ...
            <div id="collegeTypesNames" class="inputs">
                ...
                <div class="options noSelect">
                    ...
                    <div onclick="getCollegesByTypeId(2,'الكليات الصحية',this)" class="option noSelect">
                        الكليات الصحية
                    </div>
                    <div onclick="getCollegesByTypeId(3,'الكليات الإنسانية',this)" class="option noSelect">
                        الكليات الإنسانية
                    </div>
                    <div onclick="getCollegesByTypeId(4,'السنة الأولى المشتركة',this)" class="option noSelect">
            ...
            <div class="main">
          <button class="button">اضف المادة</button>
